...
class LearningHistoryCallback(tf.keras.callbacks.Callback):
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        LearningHistoryCallback.acc.append(logs['accuracy'])

    def on_train_end(self, logs=None):
        foo = self.cfg.get_prefix() + "_loss_acc.png"
        self.g.plot_metrics_evolution(LearningHistoryCallback.loss, LearningHistoryCallback.acc, LearningHistoryCallback.epochs, foo)

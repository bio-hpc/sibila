...
GRAPHS = ['model', 'loss_acc', 'roc_proba', 'confusion_matrix', 'correlation', 'PermutationImportance_hist', 'RFPermutationImportance_hist', 'Lime', 'IntegratedGradients', 'Shapley', 'Dice', 'times']
LST_PREFIX = ["ALE", "PDP"]
